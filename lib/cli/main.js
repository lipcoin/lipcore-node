...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `lipcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ lipcore-node add wallet-service');
      console.log('    $ lipcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ lipcore-node remove wallet-service');
      console.log('    $ lipcore-node remove insight-api');
      console.log();
    });
