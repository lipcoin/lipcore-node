...
/**
 * Will return the path and lipcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'lipcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'lipcore-node.json'))
  };
}
